...
function CalendarMonthDropdown({
  className,
  ...props
}: React.ComponentProps<typeof MonthsDropdown>) {
  return (
    <MonthsDropdown
      className={cn(
        "border-input bg-background text-foreground focus:border-ring focus:ring-ring [&>option]:bg-background [&>option]:text-foreground h-8 w-[100px] rounded-md border px-3 py-1 text-sm focus:ring-1 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
...
function CalendarYearDropdown({
  className,
  ...props
}: React.ComponentProps<typeof YearsDropdown>) {
  return (
    <YearsDropdown
      className={cn(
        "border-input bg-background text-foreground focus:border-ring focus:ring-ring [&>option]:bg-background [&>option]:text-foreground h-8 w-[100px] rounded-md border px-3 py-1 text-sm focus:ring-1 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
